...
class MyLogisticRegression(BaseEstimator):
    ...
    def der_reg(self):
        # TODO
        return self.w/2*self.batch_size
...
#         der_w0 = 0.
        ...
        for x_i,y_i in zip(x,y):
            ders_w+=y_i-self.h(x_i)*x_i
            der_w0+=y_i-self.h(x_i)
        ...
        return ders_w/self.batch_size,np.mean(der_w0/self.batch_size)
